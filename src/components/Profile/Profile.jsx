    ...
    const fetchVideos = () => {
      ...
      const fetchProfile = () => {
        ...
        if (token) {
          axios
            .get(
              "http://195.210.47.160/auth/profile/",
              {
                headers: {
        ...
        <div className="profile d-flex flex-column">
            <div className="profile-top d-flex">
                <div className="profile-left">
                  {profile.images && <img className="profile-left" src={`http://195.210.47.160${profile.images}`} />}
                </div>
                <div className="profile-right d-flex flex-column">
                    <p className="profile-name"><b>{profile.full_name}</b> <img src={edit} alt="" /> </p>
                    ...
                    <p className="profile-loc d-flex align-items-center"> <img className="me-2" src={location} alt="" />{profile.city}</p>
                </div>
            </div>
